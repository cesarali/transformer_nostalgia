...
Welcome to `reasoningschema` contributor's guide.
...
If you experience bugs or general issues with `reasoningschema`, please have a look
...
You can help improve `reasoningschema` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`reasoningschema` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `reasoningschema`'s files. While this mechanism can
...
```
conda create -n reasoningschema python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/reasoningschema.git
   cd reasoningschema
   ```
...
5. Install [pre-commit]:
   ...
   `reasoningschema` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/reasoningschema
[issue tracker]: https://github.com/<USERNAME>/reasoningschema/issues
