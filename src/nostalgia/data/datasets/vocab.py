...
from torchtext.vocab import Vectors, Vocab, pretrained_aliases
...
def build_vocab_from_iterator(iterator, emb_dim, voc_size, min_freq, path_to_vectors):
    ...
    if emb_dim in pretrained_aliases:
        ...
        word_vocab = Vocab(
            counter, max_size=voc_size, min_freq=min_freq, vectors=custom_vectors, specials=["<unk>", "<pad>", "<sos>", "<eos>"]
        )
    return word_vocab
